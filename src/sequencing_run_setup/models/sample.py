...
class Sample:
    ...
    # Per-sample barcode mismatches (if different from global, None = use global)
    barcode_mismatches_index1: Optional[int] = None
    barcode_mismatches_index2: Optional[int] = None
    ...
    def from_dict(cls, data: dict) -> "Sample":
        ...
        return cls(
            ...
            barcode_mismatches_index1=data.get("barcode_mismatches_index1"),
            barcode_mismatches_index2=data.get("barcode_mismatches_index2"),
