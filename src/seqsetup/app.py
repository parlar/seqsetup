...
from .data.instruments import set_instrument_definition_repo, clear_synced_instruments_cache
...
from .services.log_capture import setup_log_capture, get_log_capture_handler
...
def get_app_context() -> AppContext:
    """Create an AppContext with all repositories."""
    return AppContext(
...
# Set up log capture for admin log viewer
